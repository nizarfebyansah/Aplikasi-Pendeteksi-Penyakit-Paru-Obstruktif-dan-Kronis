...
<!--
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-user"></i> Form Pendaftaran </h3> 
              </div>
                 <div class="table-responsive">
                  ...
                  <table class="table table-condensed">
                    ...
                    <tr>
                      <td>NAMA LENGKAP</td><td><input type="text" name="nama" class="form-control" id="nama" value="<?php echo $data['nama'];?>" required/></td>
                    </tr>
                    <tr>
                      <td>AGAMA</td>
                      <td>
                      <select name="agama" class="form-control" id="agama" value="<?php echo $data['agama'];?>" required/>
                        <option>Islam</option>
                    ...
                    <tr>
                      <td>JENIS KELAMIN</td> <td><input type="radio" name="jenkel" value="Laki-Laki" readonly="readonly">Laki laki<input type="radio" name="jenkel" value="Perempuan" readonly="readonly">Perempuan</td>
                    </tr>
                    <tr>
                      <td>EMAIL</td><td><input type="email" name="email" class="form-control" id="email" value="<?php echo $data['email'];?>" required/></td>
                    </tr>
                    <tr>
                      <td colspan="2"><button type="submit" name="SIMPAN" value="SIMPAN">SUBMIT</button></td>
                    </tr>
                  </table>
                  </form> 
                   </tbody>
