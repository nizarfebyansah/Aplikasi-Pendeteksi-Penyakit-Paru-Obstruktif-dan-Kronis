                ...
                <h3 class="panel-title"><i class="fa fa-user"></i> Form Pendaftaran </h3> 
                 ...
                 <div class="table-responsive">
                  ...
                  <table class="table table-condensed">
                    ...
                    <tr>
                      <td>NAMA LENGKAP</td><td><input type="text" name="nama"></td>
                    </tr>
                    <tr>
                      <td>AGAMA</td>
                      <td>
                    ...
                    <tr>
                      <td>JENIS KELAMIN</td> <td><input type="radio" name="jenkel" value="Laki-Laki">Laki laki<input type="radio" name="jenkel" value="Perempuan">Perempuan</td>
                    </tr>
                    <tr>
