...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Aplikasi Pendekteksi penyakit">
...
<!--
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-user"></i> Informasi Penyakit </h3> 
              </div>
              <div class="panel-body">
                 <div class="table-responsive">
                  <table class="table table-bordered table-hover table-striped tablesorter">
                  <h3><b>Apa itu penyakit Paru Obstruktif Kronik ( PPOK )</b></h3>
                  <p align="justify"><font size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;adalah penyakit paru yang dapat dicegah, diobati dengan beberapa efek ekstrapulmonal yang signifikan berkontribusi terhadap tingkat keparahan penderita. Karekteristik <i><b><font color="red">pulmonal</font></b></i> penyakit ini di tandai oleh hambatan aliran udara di saluran napas yang tidak sepenuhnya reversible. Hambatan aliran udara tersebut biasanya bersifat progresif dan berhubungan dengan respon <i><b><font color="red">inflamasi pulnomal</font></b></i> terhadap partikel atau gas berbahaya, Kebiasaan merokok merupakan penyebab kausal yang terpenting. Penghentian merokok mempunyai pengaruh besar untuk mempengaruhi riwayat dari PPOK <font color="red">( Dr. Dahrizal Dahlan Sp.P )</font><br><br><h4><b>Jenis Penyakit Paru Obstruktif Kronis (PPOK) Antara Lain
                    <ol>
                      <br>
                      <li><font color="red"><b> Brongkitis Kronis </b></font></li>
                      <li><font color="red"><b> Emfisma </b></font></li>
                      <li><font color="red"><b> Asma </b></font></li>
                      <li><font color="red"><b> Brongkietasis </b></font></li>
                    </ol></b></h4></p>
                   </tbody>
                   </table>
                   </div>
