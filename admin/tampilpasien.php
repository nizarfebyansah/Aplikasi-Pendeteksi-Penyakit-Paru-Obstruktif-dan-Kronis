            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                 <div class="table-responsive">
                  <?php
                    $tampil=mysql_query("SELECT nama,agama,jenkel,email FROM users");
                    $total=mysql_num_rows($tampil); ?>
                  <table class="table table-bordered table-hover table-striped tablesorter"><tr>
                    ...
                    { ?>
                    <tr>
                    <td><font color="blue"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo $data['nama'];?></font></td>
                    <td><?php echo $data['agama']; ?></a></td>
                    <td><?php echo $data['jenkel']; ?></td>
                    <td><?php echo $data['email']; ?></td>
                    <td><a class="btn btn-sm btn-primary" href="edit.php?hal=edit&kd"><i class="fa fa-edit"></i> Edit</a>
                        <a class="btn btn-sm btn-danger" href="hapus.php?hal=hapus&kd=<?php echo $data['nama'];?>"><i class="fa fa-wrench"></i> Hapus</a></td>
                    </tr>
                 <?php   
              }
              ?>
                   ...
                   <div class="text-right">
                    <a href="print.php" class="btn btn-sm btn-warning">Cetak Data<i class="fa fa-arrow-circle-right"></i></a>
                  <a href="daftar.php" class="btn btn-sm btn-warning">Tambah Data Pasien <i class="fa fa-arrow-circle-right"></i></a>
